...
class main_ui:
    ...
    def createui(self):
        ...
        Button(self.gy,text='查看源代码',command=lambda: webb.open('https://github.com/MhwsChina/MhLauncher')).pack(anchor='w')
        Label(self.gy,text='更新日志').pack(anchor='w')
